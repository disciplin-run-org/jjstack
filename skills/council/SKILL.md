...
- If the panel converges too quickly, run one counterfactual pass (the Tenth Man) plus a Key
  Assumptions Check on what the consensus rests on.
- Adaptive stop: if Round 2 produced no position changes, skip Round 3 and synthesize — extra rounds
