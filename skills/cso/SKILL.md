...
version: 0.1.0
description: |
  Enhanced security audit — saves findings to repo, iterates to 10/10, injects DNA.
  jjstack wrapper around gstack's cso.
allowed-tools:
  - Read
  - Grep
  - Glob
...
Wraps gstack's `/cso` with repo-local output, quality loop, and DNA injection.
