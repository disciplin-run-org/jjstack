<!-- SPECIMEN, not documentation. Recovered from 918a291:skills/consensus/SKILL.md
     Three positional placeholders in the body (~$0 at the H1 and the verdict
     template, $10 in prose) that the loader rewrote, plus ~$0 in the description, which it does not. Nothing
     here was written to match a pattern; it is what the repo shipped.
