...
MUTANTS = [
    ...
    ("mention-raw-markdown", 'mentions_reviewer(item.get("body_html"))', 'mentions_reviewer(item.get("body"))'),
    ("pr-body-raw-markdown", 'mentions_reviewer(pr.get("body_html"))', 'mentions_reviewer(pr.get("body"))'),
    ("ims-not-reset",
