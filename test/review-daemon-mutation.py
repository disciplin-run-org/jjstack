...
MUTANTS = [
    ...
    ("code-spans-count", 'return _CODE_SPAN_RE.sub("", text)', "return text"),
    ("quotes-count", 'text = _QUOTE_RE.sub("", text)', "text = text"),
    ("fences-count", 'text = _FENCE_RE.sub("", text)', "text = text"),
